...
sudo mv ./ITM0544-Fall-Application-MP1/*.png /var/www/html
sudo mv ./ITM0544-Fall-Application-MP1/*.js /var/www/html
sudo mv ./ITM0544-Fall-Application-MP1/*.css /var/www/html
