...
sudo mv ./ITMO544-Fall-Application-MP1/*.css /var/www/html
sudo mv ./ITMO544-Fall-Application-MP1/*.js /var/www/html
sudo mv ./ITMO544-Fall-Application-MP1/*.png /var/www/html
